 ...
 *
 * ВАЖЛИВО: duration 12-18s (не 45-60s!) щоб рух був видимий оком.
 * willChange: 'transform' — GPU compositing на iOS Safari.
 */
export default function MeshGradient({ swipeDirection }) {
  const blobs = [
    {
      // Blob A — periwinkle/blue, верхній лівий
    ...
    {
      // Blob B — mint/teal, правий середній
    ...
    {
      // Blob D — deep violet, правий верхній
